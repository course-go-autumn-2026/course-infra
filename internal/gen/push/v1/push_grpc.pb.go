...
const (
	PushService_SendPush_FullMethodName = "/tripgo.push.v1.PushService/SendPush"
)
...
var PushService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tripgo.push.v1.PushService",
